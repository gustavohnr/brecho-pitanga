    ...
    <a
      ...
      className={cn(
        unstyled
          ...
          : "inline-flex h-11 w-11 items-center justify-center rounded-full border-2 border-white/70 bg-[#f0adbc] text-white transition hover:bg-[#f0adbc]/85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70",
        className,
      )}
    >
      <Icon
        className={cn(
          unstyled ? "h-6 w-6 text-white" : "h-5 w-5 text-white",
          iconClassName,
        )}
      />
    </a>
